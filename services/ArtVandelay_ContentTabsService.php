...
class ArtVandelay_ContentTabsService extends BaseApplicationComponent
{
	...
	public function import($tabDefs, $applyToTabs)
	{
		...
		foreach ($tabDefs as $tabname=>$tabDef) {
			...
			$sectionDefs = craft()->artVandelay_sections->export($sections, $entryTypeIds);
			...
			craft()->artVandelay_sections->import($sectionDefs);
		}
